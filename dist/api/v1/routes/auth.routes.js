...
route.post("/verify-account", rateLimit_1.publicRateLimit, controllers_1.default.AuthController.verifyAccount);
route.post("/resend/verify-account/token", rateLimit_1.publicRateLimit, controllers_1.default.AuthController.resendTokenVerifyAccount);
route.post("/resend/verify-account/otp", rateLimit_1.publicRateLimit, controllers_1.default.AuthController.resendOtpVerifyAccount);
route.post("/forgot-password", rateLimit_1.publicRateLimit, controllers_1.default.AuthController.forgotPassword);
route.post("/resend/forgot-password/otp", rateLimit_1.publicRateLimit, controllers_1.default.AuthController.resendOtpForgotPassword);
route.post("/verify-otp", rateLimit_1.publicRateLimit, controllers_1.default.AuthController.matchOtp);
route.post("/reset-password", auth_1.authenticatedResetPassword, rateLimit_1.publicRateLimit, controllers_1.default.AuthController.resetPassword);

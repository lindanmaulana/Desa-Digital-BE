...
villageProfileRouteAdmin.patch("/:id", auth_1.authenticatedUser, (0, auth_1.authorizedRoles)(client_1.UserRole.STAFF), rateLimit_1.adminRateLimit, controllers_1.VillageProfileController.update);
